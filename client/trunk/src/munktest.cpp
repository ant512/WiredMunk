...
MunkTest::MunkTest(const char* serverIP, int portNum) : WiredMunkApp(serverIP, portNum) {
}

void MunkTest::startup() {
...
void MunkTest::shutdown() {
	delete _space;
}

void MunkTest::runUser() {
...
void MunkTest::keyboard(unsigned char key, int x, int y) {
